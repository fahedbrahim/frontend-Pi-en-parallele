...
const handleupdate= (user)=>{
  ...
  props.history.push(`/homeuser/admin/updatecompany/${user._id}`)
}
...
const changePage = ({selected})=>{
  ...
  return (
    ...
    <button type="button" className="btn btn-primary mt-2" onClick={()=>{props.history.push('/homeuser/admin/companywaiting')}}>Compaies Waiting</button>
